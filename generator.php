...
<body>
    ...
    <div class="content">
        <form action="" method="post">
            ...
            <input type="text" id="imie" name="imie" placeholder="Marcin" required><br><br>
            <label for="nazwisko">Nazwisko:</label>
            <input type="text" id="nazwisko" name="nazwisko" placeholder ="Szymański" required><br><br>
            <label for="birthdate">Data urodzenia:</label>
            <input type="text" id="birthdate" name="birthdate" placeholder ="05.03.2005" required><br><br>
